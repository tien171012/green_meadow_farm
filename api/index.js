...
function serializeState(player) {
  ...
  return {
    ...
    speedBoost, goldBoost, eggTimeByAnimal,
    foodPrices: { speed: FOOD_TYPES.speed.price, gold: FOOD_TYPES.gold.price },
  };
}
...
app.get('/api/payment-info', (req, res) => {
  res.json({ zalopay: ZALOPAY_INFO, foodPrices: { speed: FOOD_TYPES.speed.price, gold: FOOD_TYPES.gold.price } });
});
